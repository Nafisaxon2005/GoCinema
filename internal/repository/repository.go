...
// UserRepo — контракт для J-03/J-04 (регистрация, логин).
...
// ShowRepo — контракт для дорожки B (организатор: сеансы и залы).
...
// SeatRepo — контракт для дорожки A (зритель: захват места под гонкой).
// TryBook должен атомарно перевести место free->booked, иначе model.ErrSeatTaken.
...
// BookingRepo — контракт для дорожки A/C (бронирование, отмена, аналитика).
